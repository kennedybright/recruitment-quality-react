...
import { CallTypes, FrameCodes, Questions } from './report-legend'
import { formatErrorAreas, getAccuracyColor } from '../../../lib/utils/qa-reports'
import { getPrintDate, isEmpty } from '../../../lib/utils/shared'
            ...
            <View>
                ...
                <View style={[tableStyles.table, {marginTop: 5}]}>
                    ...
                    <View style={[tableStyles.headerRow, tableStyles.topBorder, { fontFamily: "Helvetica-Bold", fontSize: 12 }]}>
                        ...
                        <Text style={reportStyles.cell}>Incorrect Disposition</Text>
