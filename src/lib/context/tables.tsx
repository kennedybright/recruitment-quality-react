...
// const TableDataContext = createContext<TableContextType>(null)

// // ------------------------------------------------------------------------------- //
// // Main Data Context Provider for static data

// export const TableProvider: FC = ({ children }:{ children:ReactNode }) => {
...
//         mca_category_id: mcaCategoryList
//     }), [auditTrackingList, riList, calltypeList, framecodeList, sitenameList, mcaCategoryList])
